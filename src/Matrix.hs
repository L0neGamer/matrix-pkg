...
squareMatrix2 a = VCons row $ singleton row
    where row = VCons a $ singleton a
squareMatrix3 :: a -> Matrix2 Three Three a
squareMatrix3 a = VCons row $ VCons row $ singleton row
    where row = VCons a $ VCons a $ singleton a
